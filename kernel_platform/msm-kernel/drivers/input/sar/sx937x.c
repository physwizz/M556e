...
/* M55 code for QN6887A-443|QN6887A-5569|QN6887A-5608 by zhangziyi at 20240305 start */
...
/* M55 code for QN6887A-443|QN6887A-5569|QN6887A-5608 by zhangziyi at 20240305 end */
...
/* M55 code for QN6887A-5569|QN6887A-5608 by zhangziyi at 20240305 start */
#ifdef SX937X_ANFR_LOGIC
static void smtc_anfr_irq(Self self)
{
    ...
    if (((prox_state >> 16) & 1) != gs_last_state) {
        g_irq_count++;
        gs_last_state = (prox_state >> 16) & 1;
        SMTC_LOG_INF("state update %d, g_irq_count= %d", gs_last_state, g_irq_count);
    } else {
        SMTC_LOG_INF("state not update %d", gs_last_state);
    }
}
/* M55 code for QN6887A-5569|QN6887A-5608 by zhangziyi at 20240305 end */
...
/* M55 code for QN6887A-5569 by zhangziyi at 20240301 start */
static void smtc_process_touch_status(Self self)
{
    #ifdef SX937X_ANFR_LOGIC
    if (g_anfr_flag) {
...
/* M55 code for QN6887A-5569 by zhangziyi at 20240301 end */
//#################################################################################################
...
static irqreturn_t smtc_irq_handler(int irq, void *pvoid)
{
    ...
    /* M55 code for QN6887A-5608 by zhangziyi at 20240305 start */
    SMTC_LOG_INF("cali_count:%d, anfr_flag:%d", g_cali_count, g_anfr_flag);
    /* M55 code for QN6887A-5608 by zhangziyi at 20240305 end */
    #endif //SX937X_ANFR_LOGIC
